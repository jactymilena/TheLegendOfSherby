...
HD_PWD='C:/github/TheLegendOfSherby/jeu/Atelier2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exercice2_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exercice2_bd_wrapper.tcl
