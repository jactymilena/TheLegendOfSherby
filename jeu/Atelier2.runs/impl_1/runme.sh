...
HD_PWD='C:/github/TheLegendOfSherby/jeu/Atelier2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Exercice2_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Exercice2_bd_wrapper.tcl -notrace
