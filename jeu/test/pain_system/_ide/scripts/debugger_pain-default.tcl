...
# Path of this script: C:\github\TheLegendOfSherby\jeu\test\pain_system\_ide\scripts\debugger_pain-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\github\TheLegendOfSherby\jeu\test\pain_system\_ide\scripts\debugger_pain-default.tcl
# 
...
targets -set -nocase -filter {name =~"APU*"}
source C:/github/TheLegendOfSherby/jeu/test/pain/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "*A9*#0"}
dow C:/github/TheLegendOfSherby/jeu/test/pain/Debug/pain.elf
